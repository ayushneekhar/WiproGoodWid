// Alternative version of CreateHomeScreen.tsx using built-in React Native Geolocation
// If you prefer not to install react-native-geolocation-service, you can use this version instead
// Just rename this file to CreateHomeScreen.tsx and replace the main one
...
const CreateHomeScreen: React.FC<CreateHomeScreenProps> = ({
  ...
  const getCurrentLocation = async () => {
    ...
    try {
      ...
      // Use built-in React Native Geolocation
